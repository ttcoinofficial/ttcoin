...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "TTcoin " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"190.58.199.191", "ttcoin.dx.am"},
    {"dnsseed.bluematt.me", "18.221.24.9"},
    {NULL, NULL}
};

static const char *strTestNetDNSSeed[][2] = {
    {"TTcointools.com", "testnet-seed.TTcointools.com"},
    {NULL, NULL}
};
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. TTcoin is probably already running."), addrBind.ToString().c_str());
        else
