...
#BDB_INCLUDE_PATH=C:/db-4.8.30.NC/build_windows
#BDB_LIB_PATH=C:/db-4.8.30.NC/build_windows
#OPENSSL_INCLUDE_PATH=C:/openssl-1.0.1c/include
#OPENSSL_LIB_PATH=C:/openssl-1.0.1c/
...
!win32 {
    ...
    genleveldb.commands = cd $$PWD/src/leveldb && GCC=$$QMAKE_GCC CXX=$$QMAKE_CXX $(MAKE) OPT=\"$$QMAKE_CXXFLAGS $$QMAKE_CXXFLAGS_RELEASE\" libleveldb.a libmemenv.a
} else {
...
macx:ICON = src/qt/res/icons/TTcoin.icns
